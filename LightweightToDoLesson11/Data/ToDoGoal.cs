...
public class ToDoGoal
{
    ...
    /// <summary>
    /// Task completion state, <see cref="false"/> when <see cref="ToDoGoal.CompletedAt"/> is not set
    /// </summary>
    ...
    /// <param name="text">Task text description</param>
    public ToDoGoal(int id, string text)
    ...
    /// <exception cref="ArgumentException"></exception>
    public ToDoGoal(string text, DateTime createdAt, DateTime? completedAt)
    ...
    /// <exception cref="ArgumentException"></exception>
    [JsonConstructor]
    public ToDoGoal(int id, string text, DateTime createdAt, DateTime? completedAt)
    {
